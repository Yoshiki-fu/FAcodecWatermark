...
class PseudoDataset(torch.utils.data.Dataset):
    def __init__(self,
        ...
        self.data_list = self.get_all_data_path(dir_path="/workspace/LibriTTS", extensions=['.wav']) # read your list path here
        self.sr = sr
...
def build_dataloader(
    ...
    data_loader = DataLoader(
        ...
        pin_memory=True,        # データをcudaに転送しやすくする
        prefetch_factor=prefetch_factor if num_workers > 0 else None,       # 各workerがあらかじめ読み込むbatch数
        # shuffle=True,
    )
